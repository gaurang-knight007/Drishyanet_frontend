...
const Home = () => {
    ...
    const redirectToSignUp = () => {
        ...
        if (isValidEmail(emailInputValue)) {
            navigate(`/signup?email=${encodeURIComponent(emailInputValue)}`);
        } else {
            ...
            <div className="main">
                <div className="area">
                    <h1 style={{ textDecoration: "none", color: "silver" }}>
                        Attendance Management &amp; Security
                    </h1>
                    <br />
                    ...
                    <div className="search">
                        <input type="text" className="box" id="emailInput" placeholder="Email Address" required />
                        <div className="b1">
